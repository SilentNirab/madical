...
const Banner = () => {
    return (
        <div className="bg-cover bg-center h-screen bg-[url('assets/images/banner.png')] z-auto">
            <Container>
                <div className="h-screen">
                    <div className="flex flex-col md:flex-row justify-center md:justify-between items-center h-full">
                        <div className="space-y-6 text-center md:text-left text-white">
                            <h1 className=" text-4xl mt-4 md:mt-0 md:text-6xl  font-semibold">Your Best Medical Help Center</h1>
